...
int main(int argc, char *argv[]) {
  ...
  dlist_add_back(mylist, str1,sizeof(str1));
  dlist_add_back(mylist, str2,sizeof(str2));
  dlist_add_back(mylist, str3,sizeof(str3));
  dlist_add_back(mylist, str4,sizeof(str4));
  dlist_add_back(mylist, str5,sizeof(str5));
  ...
  dlist_add_front(mylist, str1,sizeof(str1));
  dlist_add_front(mylist, str2,sizeof(str2));
  dlist_add_front(mylist, str3,sizeof(str3));
  dlist_add_front(mylist, str4,sizeof(str4));
  dlist_add_front(mylist, str5,sizeof(str5));
